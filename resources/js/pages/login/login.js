void new (class Login {
    constructor() {
        ...
        this.invalidCredentials = document.querySelector(
            ".invalid-credentials"
        );
    ...
    eventHandlers() {
        this.emailField.addEventListener("input", () =>
            this.inputStates("is-valid")
        );

        this.passwrodField.addEventListener("input", () =>
            this.inputStates("is-valid")
        );
        ...
        this.submitButton.addEventListener("click", async (e) => {
            ...
            if (this.result === "Valid")
                this.authenticate(new FormData(this.form));
        });
    }
    ...
    inputStates = (state) => {
        ...
        if (this.passwrodField.value || this.emailField.value) {
            this.emailField.classList.add(
                state === "is-valid" ? "is-valid" : "is-invalid"
            );
            this.emailField.classList.remove(
                state === "is-valid" ? "is-invalid" : "is-valid"
            );

            this.passwrodField.classList.add(
                state === "is-valid" ? "is-valid" : "is-invalid"
            );
            this.passwrodField.classList.remove(
                state === "is-valid" ? "is-invalid" : "is-valid"
            );
        }
    };
