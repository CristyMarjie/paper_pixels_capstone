                ...
                <div class="w-lg-400px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" id="user_signin_form">
                        <div class="text-center mb-10">
                            ...
                            <!--end::Title-->
                            <!--begin::Link-->
                            <div class="font-weight-bolder font-size-sm " style="color: grey;">
                                <img width="70px" src="assets/img/printlogo.png" alt="">
                                <!-- Paper Pixels -->
                            </div>
                            <!--end::Link-->
                            <h2 class="text-dark mt-5" style="font-size: 17px;">LOGIN</h2>
                        </div>
                        <!--begin::Input group-->
                        ...
                        <div class="text-center">
                            ...
                            <!--begin::Submit button-->
                            <div class="text-center text-muted text-uppercase fw-bolder mb-5">No account yet ? <a href="/sign_up">Signup here</a>.</div>
                            <button type="submit" id="submit_credentials" class="btn btn-lg btn-dark w-100 mb-5">
