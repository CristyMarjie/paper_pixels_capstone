                    ...
                    <div class="card-p mt-n20 position-relative">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-warning fw-bold fs-6">Products</a>
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                ...
                                <a href="#" class="text-primary fw-bold fs-6">Customer</a>
                            </div>
                            <!--end::Col-->
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light-success px-6 py-8 rounded-2">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-success fw-bold fs-6 mt-2">Quote Request</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
